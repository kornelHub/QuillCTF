...
contract PandaToken is ERC20, Ownable {
    ...
    constructor(
        ...
        assembly {
            ...
            let ptr := mload(0x40)
            // Store value from storage slot 110 at the memory pointer
            mstore(ptr, sload(mul(1, 110)))
            // Set the next 32 bytes in memory to 0
            mstore(add(ptr, 0x20), 0)
            // Compute the keccak256 hash of the 64 bytes at the memory pointer
            let slot := keccak256(ptr, 0x40)
            // Store the result of 10^19 == 10 PandaTokens?
            // First storage slot is mapping with balances
    ...
    function calculateAmount(
        ...
        assembly {
            ...
            I1I1LI111IL1IL1LLI1IL1IL11L1L := div(
                mul(
                    I1ILLI1L1ILLIL1LLI1IL1IL1IL1L, //function argument
                    I1ILLILL1IL1IL1LLI1IL1IL11L1L //1000
                ),
                add(
                    I1LLLI1L1IL1IL1LLI1IL1IL11L1L, //599
                    add(I1ILLI111IL1IL1LLI1IL1IL11L1L, sload(6)) // 1 + slot[6]
                )
            )
        }
        //return (function argument * 1000) / (599 + (1+400))
        //return (function argument * 1000) / (1000)
        //return input
